...
# Data: 02/09/2024
# Aula 002 - Métodos Get e Set: Métodos Assessores
...
class Usuario:
    ...
    def set_nome(self, nome):
        # Definir uma nova variável para nome (_nome)
        self._nome = nome
    ...
    def set_data_nascimento(self, data_nascimento):
        ...
        # e ajusta se a data de aniversário ainda não ocorreu neste ano
